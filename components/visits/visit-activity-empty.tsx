...
interface VisitActivityEmptyProps {
  onReset?: () => void;
}

export function VisitActivityEmpty({ onReset }: VisitActivityEmptyProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border/70 bg-white px-6 py-16 text-center">
      <p className="text-sm font-medium text-foreground">No visits found for the selected filters.</p>
